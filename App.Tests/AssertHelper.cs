...
{
    /// <summary>
    /// This class contains assert methods which can be used in unit tests for MVVM.
    /// </summary>
    public static class AssertHelper
    {
        ...
        public static void ExpectedException<T>(Action action) where T : Exception
        {
            ...
            if (!expectedExceptionThrown)
            {
                ...
                {
                    Assert.Fail(string.Format(null,
        ...
        public static void CanExecuteChangedEvent(ICommand command, Action raiseCanExecuteChanged)
        {
            ...
            EventHandler canExecuteChangedHandler = (object sender, EventArgs e) =>
            {
                if (command != sender)
                {
                    throw new Exception("The sender object of the event isn't the command");
                }
            ...
            {
                Assert.Fail("The CanExecuteChanged event wasn't raised.");
            }
            else if (canExecuteChangedCount > 1)
            {
                Assert.Fail("The CanExecuteChanged event was raised more than once.");
            }
        }
            ...
            where T : class, INotifyPropertyChanged
        {
            ...
            PropertyChangedEventHandler propertyChangedHandler = (object sender, PropertyChangedEventArgs e) =>
            {
                ...
                {
                    throw new Exception("The sender object of the event isn't the observable");
                }
